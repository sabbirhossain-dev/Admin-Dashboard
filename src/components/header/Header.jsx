...
const Header = ({darkMode, toggleDarkMode, isMenuBarOpen, setIsMenuBarOpen}) => {
  return (
    ...
    <div className='fixed top-0 left-0 w-full bg-slate-100 text-black dark:bg-slate-900 dark:text-white flex justify-between items-center p-3 border-b border-gray-300 shadow-md z-50 pl-4 pr-4 md:pl-8 md:pr-8'>
      ...
      <div className='flex items-center gap-2'>
        ...
        <div className='text-purple-700 text-2xl flex items-center gap-2'><a href='#'><BiSolidDashboard /></a> <span className='text-stone-950 dark:text-yellow-50 font-medium tracking-wider text-2xl'>Admin</span></div>
      </div>
